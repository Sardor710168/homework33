...
CREATE TABLE IF NOT EXISTS orders (
    ...
    order_status VARCHAR(30) NOT NULL DEFAULT 'panding',
    total_price BIGINT NOT NULL DEFAULT NOW(),
    created_at TIMESTAMP DEFAULT NOW(),
    CHECK (order_status IN ('panding', 'processing', 'completed', 'cancelled', 'shipped'))
);
...
CREATE TABLE IF NOT EXISTS order_detail (
    ...
    phone_id INTEGER NOT NULL REFERENCES phone(id) ON DELETE RESTRICT,
